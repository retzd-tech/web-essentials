import React__default, { useState, createContext, useContext, useEffect, forwardRef, createElement } from 'react';
import { Menu, Button as Button$1, Input } from 'antd';
...
const Navbar = props => {
  ...
  const renderMenuItem = (key, text) => /*#__PURE__*/React__default.createElement(Menu.Item, {
    key: key
  }, text);
...
const Button = props => {
  ...
  const renderButton = () => /*#__PURE__*/React__default.createElement(Button$1, {
    type: "primary",
    shape: "round",
    size: "medium",
    onClick: onClick
...
var UserOutlined$2 = /*#__PURE__*/forwardRef(UserOutlined$1);
...
const TextInput = props => {
  ...
  const renderTextInput = () => /*#__PURE__*/React__default.createElement(Input, {
